...
public class TicketService {
	...
	public Ticket saveTicket(Ticket ticket) throws TicketAlreadyExistsException {
		if(ticket.getPnrNo()!=null && ticketRepository.existsById(ticket.getPnrNo())) {
	...
	public List<Ticket> getTicketsByEmail(String userEmail) throws TicketNotExistsException {
		List<Ticket> tickets = ticketRepository.findAllByUserEmail(userEmail);
		if(tickets == null) {
